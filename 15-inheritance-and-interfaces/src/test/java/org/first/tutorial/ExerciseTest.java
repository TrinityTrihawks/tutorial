...
class ExerciseTest {
    ...
    @Test
    void tankDriveFormatsAndClamps() {
        TankDrive drive = new TankDrive();
        String output = drive.drive(0.8, 0.5); // left=1.3 -> clamp to 1.0, right=0.3
    ...
    @Test
    void mecanumDriveFormats() {
        MecanumDrive drive = new MecanumDrive();
        String output = drive.drive(0.6, -0.4); // fl=0.2 fr=1.0 after clamp
